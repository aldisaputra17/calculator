...
import (
	...
	"github.com/aldisaputra17/calculator/calculator"
)
...
getOperation:
	...
	case "+":
		...
		fmt.Print("Result: ")
		fmt.Println(calculator.Summation(firstNumber, secondNumber))
	case "-":
		var firstNumber int = stringToInt(num1)
		var secondNumber int = stringToInt(num2)
		fmt.Print("Result: ")
		fmt.Println(calculator.Subtraction(firstNumber, secondNumber))

	case "*":
		var firstNumber float64 = stringToFloat64(num1)
		var secondNumber float64 = stringToFloat64(num2)
		fmt.Print("Result: ")
		fmt.Println(calculator.Multiplication(firstNumber, secondNumber))

	case "/":
		var firstNumber float64 = stringToFloat64(num1)
		var secondNumber float64 = stringToFloat64(num2)
		fmt.Print("Result: ")
		fmt.Println(calculator.Distribution(firstNumber, secondNumber))
